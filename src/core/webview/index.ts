...
export class WebviewProvider implements vscode.WebviewViewProvider {
	public static readonly sideBarId = "cline-cn.SidebarProvider" // used in package.json as the view's id
		...
		// this.clearTask()
		{
			...
			vscode.workspace.onDidChangeConfiguration(
				async (e) => {
					...
					if (e && e.affectsConfiguration("cline-cn.mcpMarketplace.enabled")) {
