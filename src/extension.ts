...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand("cline.ttonClicked", async (webview: any) => {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand("cline.tonClicked", (webview: any) => {
	...
	context.subscriptions.push(vscode.commands.registerCommand("cline.ButtonClicked", openClineInNewTab))
	context.subscriptions.push(vscode.commands.registerCommand("cline.NewTab", openClineInNewTab))

	context.subscriptions.push(
		vscode.commands.registerCommand("cline.gsButtonClicked", (webview: any) => {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand("cline.yButtonClicked", (webview: any) => {
			WebviewProvider.getAllInstances().forEach((instance) => {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand("cline.tButtonClicked", (webview: any) => {
			WebviewProvider.getAllInstances().forEach((instance) => {
	...
	*/
	...
	context.subscriptions.push(
		vscode.commands.registerCommand("cline.hat", async (range?: vscode.Range, diagnostics?: vscode.Diagnostic[]) => {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand("cline.minalOutputToChat", async () => {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand("cline.hCline", async (range: vscode.Range, diagnostics: vscode.Diagnostic[]) => {
			// Add this line to focus the chat input first
			await vscode.commands.executeCommand("cline.hatInput")
	...
	context.subscriptions.push(
		vscode.commands.registerCommand("cline.hatInput", () => {
