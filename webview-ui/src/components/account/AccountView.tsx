			...
			{user ? (
				<div className="flex flex-col pr-3 h-full">
					...
					<div className="w-full flex gap-2 flex-col min-[225px]:flex-row">
						<div className="w-full min-[225px]:w-1/2">
							<VSCodeButtonLink href="https://app.cline-cn.bot/credits" appearance="primary" className="w-full">
								仪表盘
							</VSCodeButtonLink>
						</div>
					...
					<div className="w-full flex flex-col items-center">
						...
						<div className="w-full">
							<VSCodeButtonLink href="https://app.cline-cn.bot/credits/#buy" className="w-full">
								添加积分
							</VSCodeButtonLink>
						</div>
					</div>
				...
				<div className="flex flex-col items-center pr-3">
					...
					<p className="text-[var(--vscode-descriptionForeground)] text-xs text-center m-0">
						通过继续，您同意<VSCodeLink href="https://cline-cn.bot/tos">服务条款</VSCodeLink> 和{" "}
						<VSCodeLink href="https://cline-cn.bot/privacy">隐私政策。</VSCodeLink>
					</p>
				</div>
			)}
		</div>
