		...
		<div className="h-full flex flex-col">
			{user ? (
				<div className="flex flex-col pr-3 h-full">
					...
					<div className="w-full flex flex-col items-center">
						...
						<div className="w-full">
							<VSCodeButtonLink href="https://app.cline./credits/#buy" className="w-full">
								添加额度
							</VSCodeButtonLink>
						</div>
					</div>
				...
				<div className="flex flex-col items-center pr-3">
					...
					<p style={{}}>注册账号即可访问最新模型、计费控制面板查看使用情况和额度，以及更多即将推出的功能。</p>
					...
					<p className="text-[var(--vscode-descriptionForeground)] text-xs text-center m-0">
						继续使用即表示您同意<VSCodeLink href="https://cline./tos">服务条款</VSCodeLink>和
						<VSCodeLink href="https://cline./privacy">隐私政策</VSCodeLink>
					</p>
				</div>
			)}
		</div>
